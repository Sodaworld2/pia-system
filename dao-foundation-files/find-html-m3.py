...
# Find all HTML files in DAOV1 (excluding node_modules)
send_cmd(r"Get-ChildItem C:\Users\User\Documents\GitHub\DAOV1\ -Filter *.html -Recurse | Where-Object { $_.FullName -notlike '*node_modules*' } | Select-Object FullName, Length | Format-Table -AutoSize")
time.sleep(4)
print("=== HTML FILES IN DAOV1 ===")
