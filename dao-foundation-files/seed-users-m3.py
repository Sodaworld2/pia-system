...
send_cmd(f"[IO.File]::WriteAllBytes('C:\\Users\\User\\seed_users.py',[Convert]::FromBase64String('{b64}'));echo 'SEED_SCRIPT_WRITTEN'")
time.sleep(2)
buf = read_buffer(2000)
if 'SEED_SCRIPT_WRITTEN' in buf:
    print("Script transferred OK")
else:
    print("Transfer issue, retrying...")
    print(buf[-500:])

# Execute the seed script
send_cmd("python C:\\Users\\User\\seed_users.py")
time.sleep(5)
print("=== SEED RESULTS ===")
print(read_buffer(12000))
